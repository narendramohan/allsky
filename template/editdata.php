<?php
	...
	//attemp to collect and store form data in php variable
		try {
			...
			$applicationNumber = filter_input(INPUT_POST, "applicatonNumber");
			...
			if(isset($applicationNumber)){
				$applicationNumber = mysqli_real_escape_string($mysqli,$applicationNumber);
			}
			...
			echo "$courseType";
			$query = "UPDATE `admission_application` SET `course_type`='$courseType',`course_name`='$courseName',`payment_mode`='$payment',`amount`=$amount,`checqueno`=$chequeno,`issue_date`=STR_TO_DATE('$issudeDate', '%Y-%m-%d'),`bank_name`='$bankName',`branch_name`='$bankBranch' WHERE `applicationid`=$applicationNumber";
		    ...
		    $conn->exec($query);
		    $query ="select count(*) as noofstudent from student where applicationid=$applicationNumber";
		     echo $query . "<br>";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
			    ...
			    ($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    '$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			    $student_last_id = $conn->lastInsertId();
		    } else {
		    	$query="UPDATE `student` SET `title`='$title',`fname`='$fname',
		    	`mname`='$mname',`lname`='$lfname',`father_name`='$fathername',`mother_name`='$mothername',`dob`=STR_TO_DATE('$dob', '%Y-%m-%d'),`gender`='$gender',
		    	`bloodgroup`='$blood',`maritalstatus`='$maritalstatus',`spouse_name`='$spouse',`castcategory`='$category',`religion`='$religion',
		    	`nationality`='$nationality',`disability`='$disability' WHERE `studentid`=$studentid and `applicationid`=$applicationNumber"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			...
			//current
			$query ="select count(*) as noofstudent from student_address where studentid=$studentid and `address_type`='current'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
				...
				($student_last_id,'current','$cline1','$cline2','$cline3','$ccity','$cdistrict','$cstate',$cpin,'$ccountry','$cmobile',
				'$ctelephone','$cemail')";
			    echo $query . "<br>";
			    $conn->exec($query);
			    $student_last_id = $conn->lastInsertId();
		    } else {
		    	$query="UPDATE `student_address` SET `address_line1`='$cline1',
		    		`address_line2`='$cline2',`address_line3`='$cline3',`city`='$ccity',`district`='$cdistrict',
		    		`astate`='$cstate',`pincode`=$cpin,`country`='$ccountry',`mobileno`='$cmobile',
		    		`telephone`='$ctelephone',`email`='$cemail' WHERE studentid=$studentid and `address_type`='current'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
		    ...
		    //permanent
		    $query ="select count(*) as noofstudent from student_address where studentid=$studentid and `address_type`='permanent'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
			    $query="INSERT INTO `student_address`(`studentid`, `address_type`, `address_line1`, `address_line2`, `address_line3`, `city`, `district`, 
			`astate`, `pincode`, `country`, `mobileno`, `telephone`, `email`) VALUES 
			($student_last_id,'permanent','$line1','$line2','$line3','$city','$district','$state',$pin,'$country','$mobile','$telephone',
			'$email')";
			    echo $query . "<br>";
			    $conn->exec($query);
		    } else {
		    	$query="UPDATE `student_address` SET `address_line1`='$line1',
		    		`address_line2`='$line1',`address_line3`='$line1',`city`='$city',`district`='$district',
		    		`astate`='$state',`pincode`=$pin,`country`='$country',`mobileno`='$mobile',
		    		`telephone`='$telephone',`email`='$email' WHERE studentid=$studentid and `address_type`='permanent'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			...
			//qualification_
			//10th
			$query ="select count(*) as noofstudent from student_qualification where studentid=$studentid and `qualification_type`='10th'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
			   $query="INSERT INTO `student_qualification`(`studentid`, `qualification_type`, `education_system`, `year_of_passing`, `exam_board`, 
				...
				($student_last_id,'10th','$edusys10','$yearofpassing10','$examboard10','$schoolname10','$subject10',$percentagemark10,
				'$division10')";
				echo $query . "<br>";
				$conn->exec($query);
		    } else {
		    	$query="UPDATE `student_qualification` SET `education_system`='$edusys10',`year_of_passing`='$yearofpassing10',
		    	`exam_board`='$examboard10',`school_name`='$schoolname10',`subject`='$subject10',`permanentmarks`=$percentagemark10,
		    	`division`='$division10' WHERE studentid=$studentid and `qualification_type`='10th'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			...
			//12th
			$query ="select count(*) as noofstudent from student_qualification where studentid=$studentid and `qualification_type`='12th'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
				$query="INSERT INTO `student_qualification`(`studentid`, `qualification_type`, `education_system`, `year_of_passing`, `exam_board`, 
				`school_name`, `subject`, `permanentmarks`, `division`) VALUES 
				($student_last_id,'12th','$edusys12','$yearofpassing12','$examboard12','$schoolname12','$subject12',$percentagemark12,
				'$division12')";
				echo $query . "<br>";
				$conn->exec($query);
		    } else {
		    	$query="UPDATE `student_qualification` SET `education_system`='$edusys12',`year_of_passing`='$yearofpassing12',
		    	`exam_board`='$examboard12',`school_name`='$schoolname12',`subject`='$subject12',`permanentmarks`=$percentagemark12,
		    	`division`='$division12' WHERE studentid=$studentid and `qualification_type`='12th'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			...
			//diploma
			$query ="select count(*) as noofstudent from student_qualification where studentid=$studentid and `qualification_type`='diploma'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
				$query="INSERT INTO `student_qualification`(`studentid`, `qualification_type`, `education_system`, `year_of_passing`, `exam_board`, 
				`school_name`, `subject`, `permanentmarks`, `division`) VALUES 
				($student_last_id,'diploma','$edusysdiploma','$yearofpassingdiploma','$examboarddiploma','$schoolnamediploma',
				'$subjectdiploma',$percentagemarkdiploma,'$divisiondiploma')";
				echo $query . "<br>";
				$conn->exec($query);

		    } else {
		    	$query="UPDATE `student_qualification` SET `education_system`='$edusysdiploma',`year_of_passing`='$yearofpassingdiploma',
		    	`exam_board`='$examboarddiploma',`school_name`='$schoolnamediploma',`subject`='$subjectdiploma',`permanentmarks`=$percentagemarkdiploma,
		    	`division`='$divisiondiploma' WHERE studentid=$studentid and `qualification_type`='diploma'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			...
			//degree
			$query ="select count(*) as noofstudent from student_qualification where studentid=$studentid and `qualification_type`='degree'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
			   $query="INSERT INTO `student_qualification`(`studentid`, `qualification_type`, `education_system`, `year_of_passing`, `exam_board`, 
				`school_name`, `subject`, `permanentmarks`, `division`) VALUES 
				($student_last_id,'degree','$edusysdegree','$yearofpassingdegree','$examboarddegree','$schoolnamedegree','$subjectdegree',
				$percentagemarkdegree,'$divisiondegree')";
				echo $query . "<br>";
				$conn->exec($query);
		    } else {
		    	$query="UPDATE `student_qualification` SET `education_system`='$edusysdegree',`year_of_passing`='$yearofpassingdegree',
		    	`exam_board`='$examboarddegree',`school_name`='$schoolnamedegree',`subject`='$subjectdegree',`permanentmarks`=$percentagemarkdegree,
		    	`division`='$divisiondegree' WHERE studentid=$studentid and `qualification_type`='degree'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
			...
			//pg
			$query ="select count(*) as noofstudent from student_qualification where studentid=$studentid and `qualification_type`='pg'";
		    $result=mysql_query($query);
		    $data=mysql_fetch_assoc($result); 
		    if($data['noofstudent']==0) {
			    //student details 
		    	...
		    	$query="UPDATE `student_qualification` SET `education_system`='$edusyspg',`year_of_passing`='$yearofpassingpg',
		    	`exam_board`='$examboardpg',`school_name`='$schoolnamepg',`subject`='$subjectpg',`permanentmarks`=$percentagemarkpg,
		    	`division`='$divisionpg' WHERE studentid=$studentid and `qualification_type`='pg'"; 
			    //($last_id,'$title','$fname','$mname','$lname','$fathername','$mothername',STR_TO_DATE('$dob', '%Y-%m-%d'),'$gender','$blood','$maritalstatus','$spouse','$category',
			    //'$religion','$nationality','$disability')";
			    echo $query . "<br>";
			    $conn->exec($query);
